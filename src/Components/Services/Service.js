    ...
    return (
        <div>
            <div className="zn-bgSource-image  grid grid-cols-4 gap-5 justify-center justify-items-center"
                >
                <div className="">
                    <img className='ml-3 w-32 h-24 ' src={service_pr} alt="service_logo" />
                    <h4 className='py-5 text-lg '>Sourcing</h4>
                ...
                <div className="jfj">
                   <img className='w-36 h-24 ' src={service_prd } alt="service_logo" />
                    <h4 className='py-5 text-lg'>Research & Development</h4>
                ...
                <div className="jfj">
                    <img className='w-40 h-24 ' src={service_pm} alt="service_logo" />
                    <h4 className='py-5 text-lg'>Production</h4>
                ...
                <div className="">
                    <img className='w-24 h-20 ' src={service_ps} alt="service_logo" />
                    <h4 className='py-5 text-lg'>Operation Support</h4>
